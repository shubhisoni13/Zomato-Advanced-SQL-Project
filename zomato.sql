...
WHERE o.order_date >= CURDATE() - INTERVAL 0.5 YEAR 
...
-- List customers who have spent more than 5K on food orders.
...
WITH RANKING_TABLE AS (
    ...
    WHERE O.ORDER_DATE >= CURDATE() - INTERVAL 0.1 YEAR 
